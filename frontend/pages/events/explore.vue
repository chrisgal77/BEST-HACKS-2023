            ...
            <v-row>
              ...
              >
                ...
                >
                  ...
                  <div v-if="post.type === 'culture'" class="ml-2">
                    <v-icon>mdi-church</v-icon>
                    Kultura
                  </div>
                  <div v-if="post.type === 'recreation'" class="ml-2">
                    <v-icon>mdi-weight</v-icon>
                    Rekreacja
                  </div>
                  <div v-if="post.type === 'sightseeing'" class="ml-2">
...
export default {
  ...
  data() {
    return {
      heroAlt: [
        {
          heading: ' Wszystkie wydarzenia w okolicy ',
        },
      ],
      posts: {
        culture: [],
