        ...
        <v-container>
          <v-row class="py-16">
            <v-col cols="12">
              ...
              >
                Jesteśmy studentami 5 roku cyberbezpieczeństwa, sztucznej
                inteligencji i zarządzania.
              </h3>
            </v-col>
            <v-col cols="12" md="6">
              <p>
                W naszych projektach staramy się urzymywać standardy rynkowe
                (xD) zachowując bezpieczne praktyki w celu dostarczenia
                działającego i bezpiecznego (masło maślane) rozwiązania.
              </p>
              <blockquote class="text-h4 pa-5 my-4 font-weight-thin">
                Tutaj powinienem dać jakiś mądry tekst, ale mi się nie chce.
              </blockquote>
              <p>Ile pszczół potrzeba aby zmienić żarówkę? Więcej niż 3.</p>
            </v-col>
            <v-col cols="12" md="6">
              <p>
                ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣠⣤⣤⣤⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
          ...
          <v-col cols="12" md="6" align-self="center">
            <div class="pa-lg-16 pa-md-10 px-4 py-16">
              ...
              <h3
                class="text-h5 text-uppercase font-weight-thin text-center my-8"
              >
                Jeszcze nie odpuściłeś/aś?
              </h3>
              <p>
                Czemu mi jeszcze każesz to pisać. Naprawdę mam lepsze rzeczy do
                roboty. Ale jak już tu jesteś, jak Ci mija dzień?
              </p>
            </div>
          </v-col>
        </v-row>
